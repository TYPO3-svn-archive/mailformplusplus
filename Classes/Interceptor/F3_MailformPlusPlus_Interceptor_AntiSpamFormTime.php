 ...
 *
 * $Id: F3_MailformPlusPlus_Interceptor_Default.php 19238 2009-04-20 15:03:36Z reinhardfuehricht $
 *                                                                        */
 ...
 * Example:
 * <code>
 * saveInterceptors.1.class = F3_MailformPlusPlus_Interceptor_AntiSpamFormTime
 *
 ...
 */
class F3_MailformPlusPlus_Interceptor_AntiSpamFormTime extends F3_MailformPlusPlus_AbstractInterceptor {
	...
	public function process($gp, $settings) {
		...
		if($isSpam) {
			...
			if($this->settings['redirectPage']) {
				...
				$view = $this->componentManager->getComponent('F3_MailformPlusPlus_View_AntiSpam');
				...
				if(!$view->hasTemplate()) {
					F3_MailformPlusPlus_StaticFuncs::throwException('SPAM!!!!!!');
	...
	protected function log() {
		$logger = $this->componentManager->getComponent('F3_MailformPlusPlus_Logger_DB');
