 ...
 * @subpackage	Controller
 */
class  tx_mailformplusplus_module1 extends t3lib_SCbase {
	var $pageinfo;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailformplusplus/Classes/Controller/Module/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailformplusplus/Classes/Controller/Module/index.php']);
}
...
// Make instance:
$SOBE = t3lib_div::makeInstance('tx_mailformplusplus_module1');
$SOBE->init();
