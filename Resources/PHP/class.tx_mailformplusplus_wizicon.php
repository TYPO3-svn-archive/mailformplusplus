 ...
 */
class tx_mailformplusplus_wizicon {
	
	/**
	 * Adds the mailformplusplus wizard icon
	 *
	 * @param	array		Input array with wizard items for plugins
	 * @return	array		Modified input array, having the item for mailformplusplus
	 * pi1 added.
	 */
	...
	/**
	 * Includes the locallang file for the 'mailformplusplus' extension
	 *
	 * @return	array		The LOCAL_LANG array
	 */
	function includeLocalLang()	{
		$llFile     = t3lib_extMgm::extPath('mailformplusplus').'Resources/Language/locallang_db.xml';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailformplusplus/Resources/PHP/class.tx_mailformplusplus_wizicon.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/mailformplusplus/Resources/PHP/class.tx_mailformplusplus_wizicon.php']);
}
